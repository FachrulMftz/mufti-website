                ...
                <div class="card mt-5">
                    ...
                    <div class="card-body">
                        <form action="process.php" method="post">
                            <input id="NamaTamu" type="text" name="uname" placeholder="Nama Tamu" class="form-control mb-2">
                            <input id="Email" type="email" name="email" placeholder="Email" class="form-control mb-2">
                            <input id="AlamatRumah"type="text" name="subject" placeholder="Alamat Rumah" class="form-control mb-2">
                            <textarea id="TuliskanPesan" name="msg" class="form-control mb-2" placeholder="Tulisankan Pesan"></textarea>
